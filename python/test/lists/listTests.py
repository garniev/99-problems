...
class ListTests(unittest.TestCase):
    ...
    def test_P01(self):
        inputArray = ['a', 'b', 'c', 'd']
        lastElement = P01.P01().get_last_element(inputArray)
        self.assertEqual(lastElement, 'd')
    ...
    def test_P02(self):
        inputArray = ['a', 'b', 'c', 'd']
        secondLastElement = P02.P02().get_second_last_element(inputArray)
        self.assertEqual(secondLastElement, 'c')
    ...
    def test_P03(self):
        ...
        selectedPosition = 3
        kthElement = P03.P03().get_kth_element(inputArray, selectedPosition)
        self.assertEqual(kthElement, 'd')

    def test_P03_1(self):
        inputArray = ['a', 'b', 'c', 'd', 'e']
        selectedPosition = 5
        try:
            P03.P03().get_kth_element(inputArray, selectedPosition)
            self.assertFalse('This code should not be reached')
        except:
            self.assertTrue('Exception has been thrown')
    ...
    def test_P04(self):
        inputArray = ['a', 'b', 'c', 'd', 'e']
        arrayLength = P04.P04().get_length(inputArray)
        self.assertEqual(arrayLength, 5)
    ...
    def test_P05(self):
        inputArray = ['a', 'b', 'c', 'd', 'e']
        reversedArray = P05.P05().get_reverse_list(inputArray)
        self.assertEqual(reversedArray, ['e', 'd', 'c', 'b', 'a'])
    ...
    '''
    def test_P06(self):
        inputArray = ['x', 'a', 'm', 'a', 'x']
        isPalindrome = P06.P06().is_palindrome(inputArray)
        self.assertTrue(isPalindrome)

    def test_P06_1(self):
        inputArray = ['x', 'b', 'm', 'a', 'x']
        isPalindrome = P06.P06().is_palindrome(inputArray)
    ...
    def test_P07(self):
        inputArray = ['a', ['b', ['c', 'd'], 'e']]
        flattenArray = P07.P07().get_flatten_array(inputArray)
        self.assertEqual(flattenArray, ['a', 'b', 'c', 'd', 'e'])
    ...
    def test_P08(self):
        ...
        noDuplicates = P08.P08().get_remove_duplicates(inputArray)
        self.assertEqual(noDuplicates, ['a','b','c','a','d','e'])
